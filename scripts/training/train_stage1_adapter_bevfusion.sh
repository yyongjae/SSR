#!/usr/bin/env bash
# ==============================================================================
# Stage 1 Planning Distillation: BEVFusion Adapter Training
# Trains a per-cell residual BEV adapter on frozen BEVFusion 3DOD features.
...
export TEACHER_ADAPTER_BRANCH="bevfusion"

EXPERIMENT="${EXPERIMENT:-stage1_adapter_bevfusion}"
...
echo "======================================================================"
echo "Stage 1: Training BEVFusion Adapter for Planning Distillation"
...
if [[ "${WANDB}" != "0" ]]; then
  WANDB_ARGS+=(
    ...
    "wandb.tags=[stage1,bevfusion,adapter,global${GLOBAL_BATCH},${MAX_EPOCHS}ep]"
  )
fi
