...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"map_pc_range": (-32.0, 0.0, -2.0, 32.0, 16.0, 2.0)}, "one physical ROI"),
        ({"pc_range": (-32.0, -1.0, -2.0, 32.0, 32.0, 2.0),
          "map_pc_range": (-32.0, -1.0, -2.0, 32.0, 32.0, 2.0)}, "rear supervision"),
        ({"det_fov_half_angle_deg": 0.0}, "det_fov_half_angle_deg"),
        ({"det_fov_half_angle_deg": 91.0}, "det_fov_half_angle_deg"),
